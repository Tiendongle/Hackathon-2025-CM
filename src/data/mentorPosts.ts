...
export const mentorPosts: Post[] = [
  ...
  // },
  {
    ...
    header: "I want to be a better portrait photographer",
    summary:
      "I bought a Sony 6700 recently because I wanted to get into photography. Anyone wanna meet up downtown and take some pictures together?",
    details: "",
    price: 30,
    skilLevel: { id: 1, name: "Beginner" },
    duration: "30 mins",
